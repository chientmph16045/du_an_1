        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <form action="index.php?sp=add_sp" enctype="multipart/form-data" method="post">
                    ...
                    <input type="text" class="form-control bg-light border-0 small" name="name" aria-label="Search" aria-describedby="basic-addon2">
                    <h6 class="m-0 font-weight-bold text-primary">Giá</h6>
                    <input type="text" class="form-control bg-light border-0 small" name="price" aria-label="Search" aria-describedby="basic-addon2">
                    <h6 class="m-0 font-weight-bold text-primary">Hỉnh ảnh</h6>
                    <input type="file" class="form-control bg-light border-0 small" name="image" aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <input type="text" class="form-control bg-light border-0 small" name="quantity" aria-label="Search" aria-describedby="basic-addon2">
