...
<!-- Mirrored from ledthanhdat.vn/html/lynessa/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Mar 2023 03:25:53 GMT -->
<head>
    <meta charset="UTF-8"/>
                    ...
                    <div class="lynessa">
                        ...
                        <div class="checkout-before-top">
                            <div class="lynessa-checkout-login">
                                <div class="lynessa-form-login-toggle lynessa-form-toggle">
                                    <div class="lynessa-info">
                        ...
                        <form name="checkout" method="post" class="checkout lynessa-checkout"
                                        ...
                                        <div class="lynessa-billing-fields__field-wrapper">
                                            ...
                                            <p class="form-row form-row-wide address-field validate-state"
                                               ...
                                               data-o_class="form-row form-row-wide address-field validate-state"><label
                                                    ...
                                                    class="optional">(optional)</span></label><span
                                                    class="lynessa-input-wrapper"><input type="hidden"
                                                                                             class="hidden"
                                                                                             name="billing_state"
                                    ...
                                    <div class="lynessa-account-fields">
                                        <p class="form-row form-row-wide create-account lynessa-validated">
                                            <label class="lynessa-form__label lynessa-form__label-for-checkbox checkbox">
                                                <input class="lynessa-form__input lynessa-form__input-checkbox input-checkbox"
                            ...
                            <div id="order_review" class="lynessa-checkout-review-order">
                                <table class="shop_table lynessa-checkout-review-order-table">
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            ELOISE SHIRRED&nbsp;&nbsp; <strong class="product-quantity">×
                                            1</strong></td>
                                        <td class="product-total">
                                            <span class="lynessa-Price-amount amount"><span
                                    ...
                                    <tr class="cart-subtotal">
                                        ...
                                        <td><span class="lynessa-Price-amount amount"><span
                                                class="lynessa-Price-currencySymbol">$</span>418.00</span></td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td><strong><span class="lynessa-Price-amount amount"><span
                                                class="lynessa-Price-currencySymbol">$</span>418.00</span></strong>
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div id="payment" class="lynessa-checkout-payment">
                                    ...
                                    <div class="form-row place-order">
                                        ...
                                        <div class="lynessa-terms-and-conditions-wrapper">
                                            <div class="lynessa-privacy-policy-text"><p>Your personal data will be
                                        ...
                                        <input type="hidden" id="lynessa-process-checkout-nonce"
                                            ...
                                            value="/lynessa/?lynessa-ajax=update_order_review"></div>
                                </div>
                            </div>
                        </form>
                    </div>
